...
class TrainingDemo:
    ...
    def __init__(self):
        ...
        self.model.tokenizer = AutoTokenizer.from_pretrained('EleutherAI/gpt-neo-125M')
        
        # Test prompts for generation during training
        self.prompts = [
            "Once upon a time there was a pumpkin. It was a very special pumpkin, ",
            "Once upon a time, there lived a black cat. The cat belonged to a",
        ]
    
    def run_demo(self):
        """Run the training demonstration."""
        print("=" * 50)
        print("GPT-2 SMALL TRAINING DEMONSTRATION (Tiny Stories)")
        print("=" * 50)
